...
app.get('/', (req, res) => {
  res.render('home.ejs', { msg: 'my restaurant', RESTAURANT })
})

app.get('/menu', (req, res) => {
  res.render('./partials/menu.ejs', { msg: 'the menu', RESTAURANT })
})

app.get('/menu/:cat', (req, res) => {
  console.log(req.params)
  const index = req.params.cat
  const menuItems = []
  RESTAURANT.menu.forEach((men) => {
    if (men.category === index) {
      menuItems.push(men)
    }
  })
  res.render('./partials/category.ejs', { msg: 'the category', menuItems })
})
